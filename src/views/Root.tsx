...
import { Colors, fontFaces, Fonts } from "@src/logic/Design";
import { OverlayProvider } from "react-oot";

const STRICT_MODE = false;

const MaybeStrictMode = STRICT_MODE ? StrictMode : Fragment;
...
const GlobalStyle = createGlobalStyle({
  ...
  body: {
    ...
    background: Colors.blueGrey(950),
    display: "flex",
    alignItems: "center",
...
export function Root(): React.ReactElement | null {
